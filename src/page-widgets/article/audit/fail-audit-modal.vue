  ...
  >
    ...
    <template #body>
      ...
      <div class="form-group w-full">
        ...
        <div class="form-control h-40">
          {{ form.reason }}
        </div>
      </div>
    </template>
    <!-- <template #footer>
      <Button size="md" type="green" class="w-24" @click="deleteAudit" async>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    // const deleteAudit = async (done) => {
    //   const res = await store.dispatch("article/audit/delete", {
    //     articleId: form.id,
    //     auditStatus: true,
    //   });
